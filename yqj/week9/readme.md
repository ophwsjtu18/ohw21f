# Code for homework
## YOLO算法识别手机，根据手机位置控制我的世界人物前后左右跑动
## code
```python
import numpy as np
import cv2
...
# aaaaaaaaaaaaaaa源代码，未改动aaaaaaaaaaa
yolo_dir = 'E:\\hardware_course\\yolov3'  # YOLO文件路径一定不能有中文在路径里面
...
# bbbbbbbbbbbbbbbbbb源代码，未改动bbbbbbbbbbbbbbbbbbb

    img=cv2.flip(img,1)#将画面镜像翻转
